...
export const LayersPanel: React.FC<Props> = ({
  ...
  return (
    <div className="fixed sm:right-4 sm:top-24 right-0 bottom-0 sm:bottom-auto sm:w-60 w-full z-[50] bg-white/90 shadow-2xl rounded-t-3xl sm:rounded-3xl border-t sm:border border-slate-200/60 p-4.5 max-h-[45vh] sm:max-h-[60vh] overflow-y-auto backdrop-blur-md transition-all duration-300 hover:shadow-3xl flex flex-col">
